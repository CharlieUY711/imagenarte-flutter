...
import 'package:imagenarte/presentation/widgets/collage_overlay.dart';
import 'package:imagenarte/presentation/widgets/zoom_dial.dart';
    ...
    return Consumer<EditorUiState>(
      builder: (context, uiState, child) {
        ...
        switch (ctx) {
          ...
          case EditorContext.collage:
            return const CollageOverlay();
          ...
          case EditorContext.action_metadata:
            return MetadataOverlay(imagePath: imagePath);
          case EditorContext.zoom:
            return const ZoomDial();
