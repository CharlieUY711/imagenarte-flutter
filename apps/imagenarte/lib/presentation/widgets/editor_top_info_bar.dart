...
class _EditorTopInfoBarState extends State<EditorTopInfoBar> {
  ...
  void _triggerMetricsRecalc(EditorUiState uiState) {
    ...
    final isSelectionTool = uiState.activeTool == EditorTool.scissors;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<EditorUiState>(
      builder: (context, uiState, child) {
        ...
        // Herramienta de selección geométrica removida
        final isSelectionTool = uiState.activeTool == EditorTool.freeSelection ||
  ...
  Future<void> _executeScissors(BuildContext context, EditorUiState uiState) async {
    ...
    try {
      ...
      await ImageExportHelper.exportImage(
        image: resultImage,
        outputPath: newPath,
