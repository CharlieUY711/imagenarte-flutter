...
1. **`figma_extracted/` en historial:**
...
2. **`package-lock.json` en raíz (historial):**
...
## 🛡️ Qué Barreras Se Agregaron (F3)
...
### PR #1: `chore/repo-saneamiento-F3-barriers` → `main`
...
### PR #2: `chore/repo-saneamiento-F4-sanitize` → `main`
